...
regressorRF_NOX = pickle.load(open('C:/Users/medha/Desktop/New folder/Random_Forest_model_2.sav','rb'))
...
img = get_img_as_base64("C:/Users/medha/Desktop/New folder/Praticle/Pages/image 3.jpg")

page_bg_img = f"""
<style>
[data-testid="stAppViewContainer"] > .main {{
background-image: url("https://images7.alphacoders.com/351/351853.jpg");
background-size: 100%;
...
def main():
    with st.sidebar:
       select = st.radio(label='Predicting NOX CO gas using Various Maching Learning Models',options =['Prediction NOx gas',
                                                                                                       ], )
        
       if select == 'Prediction NOx gas':
           
           st.title("Prediction Nox gas")
    ...
    if st.button('NOX predicted VALUES'):
        NOX_RF = NOX_prediction([[AT, AP, AH, AFDP, GTEP, TIT, TAT, TEY, CDP]])
